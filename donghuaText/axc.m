...
- (void)star{
    ...
    [self performSelector:@selector(TheThirdAnimation) withObject:nil afterDelay:1.5f];
}
...
- (void)TheFourthAnimation{
    ...
    for (int i = 1; i <= 23; i ++) {
        ...
        UIBezierPath *_path;
        CGFloat x = 35 + i * ((ScreenWidth - 55) / 25);
        CGPoint point1= CGPointMake(x, 55);
        CGPoint point2= CGPointMake(x, ScreenHeight - 45);
...
- (void)TheThirdAnimation{
    ...
    [self performSelector:@selector(TheAnimation) withObject:nil afterDelay:0.5];
}
- (void)TheAnimation
{
    UIBezierPath * _path;
    //贝塞尔曲线
    CGPoint qidian = CGPointMake(15, ScreenHeight-15);
    CGPoint zhongdian = CGPointMake(45, ScreenHeight-45);
    CGPoint zhongdian2 = CGPointMake(ScreenWidth-45, ScreenHeight-45);
    CGPoint zhongzhi = CGPointMake(ScreenWidth-15, ScreenHeight-15);
    
    _path = [UIBezierPath bezierPath];
    [_path moveToPoint:qidian];
    [_path addLineToPoint:zhongdian];
    [_path addLineToPoint:zhongdian2];
    [_path addLineToPoint:zhongzhi];
    CAShapeLayer * shapeLayer = [CAShapeLayer layer];
    shapeLayer.path = _path.CGPath;
    shapeLayer.fillColor=[UIColor clearColor].CGColor;//填充颜色
    shapeLayer.strokeColor=lineColor.CGColor;//边框颜色
