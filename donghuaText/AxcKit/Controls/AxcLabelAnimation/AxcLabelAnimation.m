...
@interface AxcLabelAnimation ()

@property (nonatomic, strong) NSMutableArray <AxcSingleText *>*allText;
...
@implementation AxcLabelAnimation
...
- (void)drawRect:(CGRect)rect {
    ...
    [self.allText enumerateObjectsUsingBlock:^(AxcSingleText *singleText, NSUInteger idx, BOOL *stop) {
        CGFloat location = 0;
...
- (void)setText:(NSString *)text
{
    ...
    for (int i = 0; i < text.length; ++i) {
        ...
        AxcSingleText *singleText = [AxcSingleText singleTextWithAnimationRange: text.length];
...
- (void)setAttributedText:(NSAttributedString *)attributedText
{
    ...
    for (int i = 0; i < attributedText.length; ++i) {
        ...
        AxcSingleText *singleText = [AxcSingleText singleTextWithAnimationRange: attributedText.length];
...
- (void)setType:(AxcLabelAnimationType)type
{
    _type = type;
    self.loopCount = -1;
    [self.allText makeObjectsPerformSelector:@selector(normalReset)];
...
- (NSMutableArray<AxcSingleText *> *)allText
{
    if (!_allText) {
