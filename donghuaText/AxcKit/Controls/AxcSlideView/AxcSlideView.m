...
@interface AxcSlideView()<UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate>


@property (nonatomic,strong)UITableView *tableView;
@property (nonatomic,strong)UIView *superView;
@end
@implementation AxcSlideView
{
    UIView *viewBack;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_delegate respondsToSelector:@selector(axcSlideView:didSelectAtIndex:)]) {
        [_delegate axcSlideView:self didSelectAtIndex:IndexRow];
    }
}
