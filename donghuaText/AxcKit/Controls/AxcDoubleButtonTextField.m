...
@implementation AxcDoubleButtonTextField
...
- (void)searchTextButton:(UIButton *)sender{
    if ([self.delegate respondsToSelector:@selector(axcTextFiledButton:atIndex:)]) {
        [self.delegate axcTextFiledButton:self atIndex:sender.tag];
    }
}
//  重写占位符的x值
