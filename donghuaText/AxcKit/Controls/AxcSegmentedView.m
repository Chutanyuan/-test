...
@implementation AxcSegmentedView
...
- (void)setSelectNumber:(NSInteger)selectNumber {
    ...
    if ([_delegate respondsToSelector:@selector(axcSegmentedView:didSelectTitleInteger:)]) {
        BOOL isSelect = [_delegate axcSegmentedView:self didSelectTitleInteger:selectNumber];
    ...
    if ([_delegate respondsToSelector:@selector(axcSegmentedView:selectTitleInteger:)]) {
        [_delegate axcSegmentedView:self selectTitleInteger:self.selectNumber];
    }
...
- (void)buttonClick:(UIButton *)sender {
    ...
    if ([_delegate respondsToSelector:@selector(axcSegmentedView:didSelectTitleInteger:)]) {
        BOOL isSelect = [_delegate axcSegmentedView:self didSelectTitleInteger:select];
