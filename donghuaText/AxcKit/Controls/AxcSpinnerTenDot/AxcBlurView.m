...
@implementation UIImage (AxcBlurView)
...
- (void)setBlurEnabled:(BOOL)blurEnabled
{
    ...
    if (blurEnabled)
    {
        for (AxcBlurView *view in self.views)
        {
...
- (void)removeView:(AxcBlurView *)view
{
