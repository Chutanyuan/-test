...
#define Length 5
#define Length2 15
@interface AxcPopView ()<UITableViewDelegate, UITableViewDataSource>
...
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(AxcPopView:didSelectAtIndexPathOfRow:)]) {
        [self.delegate AxcPopView:self didSelectAtIndexPathOfRow:indexPath.row];
    }
}
@end
