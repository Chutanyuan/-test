...
- (void)setVerticalShowDataArr:(NSMutableArray *)dataArr
{
    ...
    AxcTopLineViewModel *model = _dataArr[count];
...
- (void)dealTap:(UITapGestureRecognizer *)tap
{
    ...
    if ([_delegate respondsToSelector:@selector(axcTopLineView:didSelectAtIndex:)]) {
        [_delegate axcTopLineView:self didSelectAtIndex:count];
    }
}
