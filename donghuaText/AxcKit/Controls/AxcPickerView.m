...
@interface AxcCollectionViewLayout : UICollectionViewFlowLayout
@end

@interface AxcPickerView () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) UICollectionView *collectionView;
- (CGFloat)offsetForItem:(NSUInteger)item;
- (void)didEndScrolling;
@end

@implementation AxcPickerView
...
- (void)initialize
{
	...
	self.collectionView = [[UICollectionView alloc] initWithFrame:frame
											 collectionViewLayout:[AxcCollectionViewLayout new]];
...
@interface AxcCollectionViewLayout ()
@property (nonatomic, assign) CGFloat width;
@property (nonatomic, assign) CGFloat midX;
@property (nonatomic, assign) CGFloat maxAngle;
@end

@implementation AxcCollectionViewLayout
