...
- (void)panAction:(UIPanGestureRecognizer *)pan {
    ...
    if (pan.state == UIGestureRecognizerStateBegan) {
        ...
        if (radius_B >= radius_A / 10) {
            ...
            if ([_delegate respondsToSelector:@selector(axcBubbleViewCleanMessage:isClear:)]) {
                [_delegate axcBubbleViewCleanMessage:self isClear:NO];
            }
        } else {
            ...
            if ([_delegate respondsToSelector:@selector(axcBubbleViewCleanMessage:isClear:)]) {
                [_delegate axcBubbleViewCleanMessage:self isClear:YES];
            }
        }
