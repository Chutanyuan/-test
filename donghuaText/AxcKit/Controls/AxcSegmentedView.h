...
/*
 ...
 代理方法：
 提供
 - (void)axcSegmentedView:(XSSegmentedView *)XSSegmentedView selectTitleInteger:(NSInteger)integer;
 - (BOOL)axcSegmentedView:(XSSegmentedView *)XSSegmentedView didSelectTitleInteger:(NSInteger)integer;
 代理方法，
 具体功能见代码注释
 */
...
@protocol AxcSegmentedViewDelegate;

@interface AxcSegmentedView : UIView
...
@property (nonatomic, weak) id <AxcSegmentedViewDelegate> delegate;

@end

@protocol AxcSegmentedViewDelegate <NSObject>
