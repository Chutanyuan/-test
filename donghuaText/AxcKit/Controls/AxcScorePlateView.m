...
@implementation AxcScorePlateView
...
- (void)drawRect:(CGRect)rect {
    ...
    lbeAltitude.textColor = CONTENT_COLOR;
    ...
    lbeSpeed.text = @"服务态度";
    lbeSpeed.textColor = CONTENT_COLOR;
    ...
    self.compreValue.textColor = CONTENT_COLOR;
    ...
    self.lbeCompreValue.textColor = CONTENT_COLOR;
    ...
    self.comment.textColor = CONTENT_COLOR;
...
-(void)drawHalfCircle:(CGPoint) center andWithRadius:(CGFloat)radius isTop:(BOOL) top
{
    ...
    CGContextSetStrokeColorWithColor(ctx, CONTENT_COLOR.CGColor);
